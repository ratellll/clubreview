...
GET  | /users/check | 회원가입시 통합 중복체크(username,phoneNumber,nickname)
...
GET | /admin/users/list | 유저목록


POST | /admin/users/delete/{id} | 유저탈퇴


POST | /admin/users/ban/{id} | 유저정지


POST | /admin/users/unban/{id} | 유저정지
...
GET | /clubs/admin/new | 클럽생성폼이동


POST | /clubs/admin/new | 클럽생성처리


GET | /clubs/admin/edit/{id} | 클럽수정폼


POST | /clubs/admin/edit/{id} | 클럽수정처리


POST | /clubs/admin/delete/{id} | 클럽삭제처리
...
GET | /mypage/list | user정보와 review가져오는 마이페이지


POST | /mypage/editNickname | 닉네임수정처리


POST | /mypage/editPassword | 비밀번호수정처리


POST | /mypage/reviews/edit | 리뷰수정처리


POST | /mypage/reviews/delete/{id} | 리뷰삭제처리


## ReviewController (RequestMapping("/reviews"))


POST | /reviews/add | 리뷰등록처리


POST | /reviews/user/edit/{id} | 리뷰수정처리


POST | /reviews/user/delete/{id} | 리뷰삭제처리


POST | /reviews/admin/edit/{id} | 어드민 리뷰수정처리


POST | /reviews/admin/delete/{id} |어드민 리뷰삭제처리
